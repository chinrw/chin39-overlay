...
EGIT_SUBMODULES=('-*' 'dynarmic' 'sirit' 'xbyak' 'tzdb_to_nx' 'externals/nx_tzdb/tzdb_to_nx/externals/tz/tz' 'VulkanMemoryAllocator' 'mbedtls' 'mbedcrypto' 'simpleini' 'Vulkan-Utility-Libraries')
